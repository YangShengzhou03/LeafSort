...
#define MyAppExeName "LeafSort.exe"
...
OutputBaseFilename=LeafSort Setup
SetupIconFile=D:\code\Python\LeafSort\resources\img\setup.ico
Compression=lzma2/max
SolidCompression=yes
WizardStyle=modern
AppCopyright=© 2025 LeafSort by YangShengzhou.版权所有
