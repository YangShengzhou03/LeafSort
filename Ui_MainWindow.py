...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/list/媒体导入.svg")), QtGui.QIcon.Mode.Normal,
                       QtGui.QIcon.State.Off)
        item.setIcon(icon)
        self.listNavigationMenu.addItem(item)
        item = QtWidgets.QListWidgetItem()
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/list/智能整理.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        item.setIcon(icon1)
        self.listNavigationMenu.addItem(item)
        item = QtWidgets.QListWidgetItem()
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/list/文件去重.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        item.setIcon(icon2)
        self.listNavigationMenu.addItem(item)
        item = QtWidgets.QListWidgetItem()
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/list/属性写入.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        item.setIcon(icon3)
        self.listNavigationMenu.addItem(item)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/窗口控制/microsoft.svg")),
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/窗口控制/github.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/窗口控制/最小化.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/窗口控制/关闭.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        ...
        self.textBrowser_import_info.setTextInteractionFlags(
            QtCore.Qt.TextInteractionFlag.LinksAccessibleByKeyboard | QtCore.Qt.TextInteractionFlag.LinksAccessibleByMouse)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Policy.Expanding,
                                            QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.btnAddressTag.setStyleSheet("QPushButton {\n"
                                         ...
                                         "}")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/page_2/位置.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(get_resource_path("resources/img/page_4/星级_暗.svg")), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblSourceFolder.setText(_translate("MainWindow", "处理文件夹："))
        ...
        self.copyrightLineEdit.setPlaceholderText(_translate("MainWindow", "©2026 LeafSort"))
        ...
        self.btnStartExif.setText(_translate("MainWindow", "开始写入EXIF数据"))
        self.lblDefault.setText(
            _translate("MainWindow", "注意 - 写入EXIF为高危操作，自动将写入后的文件复制到目标文件夹中。"))
