...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def _show_settings(self):
        try:
            ...
            QtWidgets.QMessageBox.warning(self, "Error", f"Error opening settings dialog: {e}")
    ...
    def _browse_directory(self, dialog_title, target_widget):
        try:
            ...
            if folder_path:
                ...
                self.log("INFO", f"Selected {dialog_title.replace('选择', '')}: {folder_path}")
        except Exception as e:
            self.log("ERROR", f"Failed to open {dialog_title} dialog: {e}")
